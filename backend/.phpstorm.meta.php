...
'view.paths','view.compiled','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','fortify.guard',
...
'session.http_only','session.same_site','session.partitioned','telegram.bot_token','telegram.webhook_url',
'tinker.commands','tinker.alias','tinker.dont_alias','ide-helper.filename','ide-helper.models_filename',
...
'pagination::tailwind','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'SESSION_SAME_SITE','SANCTUM_STATEFUL_DOMAINS','FRONTEND_URL','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','CACHE_DRIVER','CACHE_STORE','MEMCACHED_HOST','REDIS_CLIENT',
