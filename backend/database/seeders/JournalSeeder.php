...
class JournalSeeder extends Seeder
{
    ...
    {
        // Do not insert sample journals in production by default
        ...
        DB::transaction(function () use ($user) {
            // Use firstOrCreate to avoid duplicate journal entries
        ...
        $this->command->info('Journal entries seeded successfully for user: '.$user->name);
    }
}
