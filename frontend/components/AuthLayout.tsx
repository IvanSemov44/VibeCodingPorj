  ...
  return (
    <div className="max-w-[480px] my-[60px] mx-auto px-5">
      <div className="text-center mb-8">
        <h1 className="m-0 mb-2 text-[32px] font-bold text-primary-text">{title}</h1>
      ...
      {footerText && (
        <div className="text-center mt-6 text-secondary-text text-sm">
          ...
          {footerLink && (
            <Link
              href={footerLink}
              className="text-accent font-medium no-underline hover:text-accent-hover transition-colors"
            >
              {footerLinkText}
            </Link>
          )}
