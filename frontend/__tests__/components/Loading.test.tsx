...
describe('Loading components', () => {
  test('LoadingSpinner renders with given size', () => {
    const { container } = renderWithProviders(<LoadingSpinner size="sm" /> as unknown as JSX.Element);
  ...
  test('LoadingSpinner applies inline color style when provided', () => {
    const { container } = renderWithProviders(<LoadingSpinner size="md" color="#123456" /> as unknown as JSX.Element);
    const el = container.firstChild as HTMLElement;
